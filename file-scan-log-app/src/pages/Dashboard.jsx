...
export default function Dashboard() {
    ...
    const smallButton =
        "text-white text-sm font-medium px-4 py-2 rounded-lg transition inline-flex items-center justify-center w-auto min-w-[140px]";
        ...
        <div className="min-h-screen bg-slate-950 text-white">
            ...
            <main className="max-w-7xl mx-auto p-6">
                ...
                <div className="mt-8 bg-slate-900 border border-slate-800 rounded-2xl p-6">
                    ...
                    {scanResult && (
                        <div className="mt-4 p-3 rounded-xl bg-slate-800 text-center">
                            {scanResult}
                        </div>
                    )}
                </div>
                                    ...
                                    >
                                        ...
                                        <td className="py-3 text-center">
                                            <button
                                                ...
                                                className="bg-green-600 hover:bg-green-700 text-white text-xs font-medium px-3 py-1 rounded-lg transition min-w-[70px]"
                                            >
                                                PDF
                                            </button>
                                        </td>
